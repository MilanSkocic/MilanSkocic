...
\hypersetup{
    ...
    pdftitle={PhotoElectrochemistry --- Fitting Procedure},    % title
...
% FITTING
\input{./src/02-fitting_procedure.tex}

% CI
\input{./src/03-estimation_ci.tex}

% APPLICATION
\input{./src/04-application.tex}

% CONCLUSION
\clearpage
\input{./src/05-conclusion.tex}
