...
\subsection{Electronic Band Structure}
    \begin{frame}[allowframebreaks=1.0]{Band Model}
        ...
        \begin{figure}[h]
            \centering
                \includegraphics[width=0.5\textwidth]{tikz_band_model.png}
    ...
    \begin{frame}{Excitation carrier}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[width=0.5\textwidth]{tikz_excitation_carrier.png}
    ...
    \begin{frame}{Fermi Level Position}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.5\textwidth]{tikz_fermi_position.png}
...
\subsection{Semiconductor/electrolyte interface in dark condition}
    \begin{frame}[allowframebreaks=1.0]{Band Bending}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[width=0.5\textwidth]{tikz_interface_potential.png}
        ...
        \begin{figure}[H]
        \centering
            \includegraphics[width=0.6\textwidth]{tikz_band_bending.png}
